...
ep.app = (function() {
  ...
  var epViews = ep.epocViews;
  var dispatcher;

  var Slideshow = React.createClass({displayName: "Slideshow",
    propTypes: {
      dispatcher: React.PropTypes.instanceOf(ep.Dispatcher).isRequired
    },
  ...
  var Slide = React.createClass({displayName: "Slide",
    ...
    renderChoiceSlide: function() {
      return (
        React.createElement(epViews.ChoicesView, {
...
define(["build/materialViews", "build/epocViews", "utils", "slideshowData"],
  function(materialViews, epocViews, utils, slideshowData) {

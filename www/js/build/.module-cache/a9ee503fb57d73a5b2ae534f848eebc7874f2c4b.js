...
ep.materialViews = (function() {
  var RippleButton = React.createClass({displayName: "RippleButton",
    ...
    render: function() {
      ...
      return (
        React.createElement("button", {className: classNames(cssClasses), onClick: this.props.onClick}, 
  ...
  var Input = React.createClass({displayName: "Input",
    ...
    validateInput: function () {
      var input = this.getDOMNode().querySelector("input");
      var hasValue = input.value.length !== -1;
      console.info(hasValue, input.value);
